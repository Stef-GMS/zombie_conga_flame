...
This is a Flutter version of the Zombie Conga app from the _[2D Apple Games by Tutorials Ed 3.0](https://www.kodeco.com/379-2d-apple-games-by-tutorials-updated-for-swift-4-and-ios-11)_ book published by [Kodeco.com](https://www.kodeco.com/), formerly raywenderlich.com.  It was created using Very Good Ventures [Flame game template](https://verygood.ventures/dev/tools) `very_good create flame_game`.
